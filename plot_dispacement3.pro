pro plot_dispacement3 ,maskzero=maskzero,import_index=import_index, maskleavey=maskleavey
...
;  junk = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Energy gain [keV]$',sym_filled=1,sym_size=.6,xrange=[zero,final],font_size=30,dim=[1820,980],axis_Style=1,name=['$E_{y}$ potential drop (no turbulence)'],yrange=[0,ymaz])
;  junkwhite = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Energy gain [keV]$',sym_filled=1,sym_size=.6,xrange=[zero,final],font_size=30,dim=[1820,980],axis_Style=1,name=['Individual Ions'],sym_color='white',/current,yrange=[0,ymaz])
;  junky = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Energy gain [keV]$',sym_filled=1,sym_size=.35,xrange=[zero,final],font_size=30,dim=[1820,980],axis_Style=1,name=['Individual Ions'],/current,yrange=[0,ymaz])

;  junk1=  plot(redispe/re,Ey0*redispes/1000000,overplot=1,color='red',thick=4,name=['$E_{y_0}$ potential drop (no turbulence)'])


  junk2 = scatterplot(redisp/re,redelta/1000,xtitle='Displacement along y [$R_E$]',sym_filled=1,sym_size=0.6,xrange=[zero,final],font_size=30,axis_Style=1,sym='star',name=['Simulation Ions (turbulence)'],sym_color='blue',yrange=[0,ymaz])
  junkwhite = scatterplot(redisp/re,redelta/1000,xtitle='Displacement along y [$R_E$]',sym_filled=1,sym_size=.7,xrange=[zero,final],font_size=30,axis_Style=1,name=['simulation Ions'],sym_color='white',sym='star',yrange=[0,ymaz])
  junky = scatterplot(redisp/re,redelta/1000,xtitle='Displacement along y [$R_E$]',sym_filled=1,sym_size=.35,xrange=[zero,final],font_size=30,axis_Style=1,name=['Simulation Ions'],sym_color='blue',sym='star',yrange=[0,ymaz])
  
  junk = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Energy gain [keV]$',sym_filled=1,sym_size=.6,xrange=[zero,final],font_size=30,dim=[1820,980],axis_Style=1,name=['$E_{y}$ potential drop (no turbulence)'],yrange=[0,ymaz],overplot=1)
  junkwhite = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Energy gain [keV]$',sym_filled=1,sym_size=.6,xrange=[zero,final],font_size=30,dim=[1820,980],axis_Style=1,name=['Individual Ions'],sym_color='white',/current,yrange=[0,ymaz],overplot=1)
  junky = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Energy gain [keV]$',sym_filled=1,sym_size=.35,xrange=[zero,final],font_size=30,dim=[1820,980],axis_Style=1,name=['Individual Ions'],/current,yrange=[0,ymaz],overplot=1)


 ; junk3=  plot(redisp/re,Ey0*redisps/1000000,overplot=1,color='red',thick=4,name=['$E_{y_0}$ potential drop'])

  leg = legend(target=[junk,junk2],position=[.55,.95],font_size=27,sample_width=.06,LINESTYLE=6)


  print,mean(disp)/ymax
  print,mean(fines-inis)*0.1 ;finis is in goodx space so it doesn't count

  junk.save,'displacement.png'

pro plottrajectories

  restore, 'trajectoriesBALLe0b0.sav'
  ...
  n3 = [drift_towards, jets]
    ...
    junk = ddsega_plot_trajectory(trajectories, n3[0], box_str,ddd=1)
  ...
  n3 = [drift_towards, jets]
    ...
    junk = ddsega_plot_trajectory(trajectories, n3[0], box_str,ddd=1)
    junk = ddsega_plot_trajectory(trajectories, n3[1], box_str,ddd=1,overplot=1,scalebar=1)

    cd, 'dump3d'
    write_png,'trajturb.png',tvrd(/true)
    cd,'..'

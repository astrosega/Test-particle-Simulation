pro plot_dispacement4 ,maskzero=maskzero,import_index=import_index, maskleavey=maskleavey
...
fsize=24
  ...
  junk = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Final Energy [keV]$',sym_filled=1,sym_size=.6,xrange=[zero,final],font_size=fsize,dim=[1820,980],layout=[2,1,1],margin=[.2,.15,.05,.1],axis_Style=1,name=['Simulation ions (no turbulence)'],yrange=[0,130],title='No Turbulence')
  junkwhite = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Final Energy [keV]$',sym_filled=1,sym_size=.6,xrange=[zero,final],font_size=fsize,dim=[1820,980],layout=[2,1,1],margin=[.2,.15,.05,.1],axis_Style=1,name=['Individual Ions'],sym_color='white',/current,yrange=[0,130])
  junky = scatterplot(redispe/re,redeltae/1000,xtitle='Displacement along y [$R_E$]', ytitle='$Final Energy [keV]$',sym_filled=1,sym_size=.35,xrange=[zero,final],font_size=fsize,dim=[1820,980],layout=[2,1,1],margin=[.2,.15,.05,.1],axis_Style=1,name=['Individual Ions'],/current,yrange=[0,130])

  junk1=  plot(redispe/re,Ey0*redispes/1000000,overplot=1,color='red',thick=4,name=['$E_{y_0}$ potential drop'])


  junk2 = scatterplot(redisp/re,redelta/1000,xtitle='Displacement along y [$R_E$]',sym_filled=1,sym_size=0.6,xrange=[zero,final],font_size=fsize,/current,layout=[2,1,2],margin=[.12,.15,.05,.1],axis_Style=1,sym='star',name=['Simulation Ions (turbulence)'],sym_color='blue',yrange=[0,130],title='Turbulence')
  junkwhite = scatterplot(redisp/re,redelta/1000,xtitle='Displacement along y [$R_E$]',sym_filled=1,sym_size=.7,xrange=[zero,final],font_size=fsize,layout=[2,1,2],margin=[.12,.15,.05,.1],axis_Style=1,name=['simulation Ions'],sym_color='white',/current,sym='star',yrange=[0,130])
  junky = scatterplot(redisp/re,redelta/1000,xtitle='Displacement along y [$R_E$]',sym_filled=1,sym_size=.35,xrange=[zero,final],font_size=fsize,layout=[2,1,2],margin=[.12,.15,.05,.1],axis_Style=1,name=['Simulation Ions'],/current,sym_color='blue',sym='star',yrange=[0,130])
